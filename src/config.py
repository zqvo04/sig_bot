...
설계 원칙:
  ...
  3. 보수성: 보너스 항목 18개로 정리, 최대 캡 28pt (기존 35pt)
...
# ── 티어드 보너스 캡 (v3: 하향 조정) ─────────────────────────
# base < 40pt: 캡 15pt — 중립 시장, 보너스로 구제 불가
# 40 ≤ base < 48pt: 캡 22pt — 약한 방향성
# base ≥ 48pt: 캡 28pt — 명확한 방향성 (기존 35 → 28)
BONUS_CAP_TIERS = [(40, 15), (48, 22), (9999, 28)]
